...
from utils.api_urls import PASSWORD_RESET_URL, PASSWORD_RESET_CONFIRM_URL
...
class TestPasswordReset:
    ...
    def test_request_password_reset_email(self):
        ...
        with allure.step("Send POST /password-reset to request password reset"):
    ...
    def test_password_reset_with_invalid_token(self):
        with allure.step("Send POST /password-reset/reset with invalid token"):
